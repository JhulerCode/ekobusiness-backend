    ...
    try {
        ...
        if (qry) {
            ...
            if (qry.fltr) {
                ...
                // delete qry.fltr.articulo_unidad
                Object.assign(findProps.where, applyFilters(qry.fltr))
            ...
            if (qry.cols) {
                ...
                const excludeCols = ['articulo_nombre', 'produccion_orden_tipo', 'produccion_orden_maquina', 'producto_estado']
